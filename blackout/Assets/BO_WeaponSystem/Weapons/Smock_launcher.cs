...
public class Smock_launcher : Weapon {
    ...
    public override string weaponName { get; set; } = "smoke launcher";
    public override int? remainAmmo { get; set; } = 50;
